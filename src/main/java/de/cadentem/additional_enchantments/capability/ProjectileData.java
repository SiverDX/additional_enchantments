...
public class ProjectileData {
    ...
    public void handleHomingMovement(final Projectile instance) {
        if (homingTarget == null) {
            if (homingTargetId != -1) {
                Entity entity = instance.level().getEntity(homingTargetId);
    ...
    public void searchForHomingTarget(final Projectile instance) {
        ...
        ConfigurationProvider.getCapability(serverPlayer).ifPresent(configuration -> {
            ...
            List<LivingEntity> entities = serverPlayer.level().getEntitiesOfClass(LivingEntity.class, instance.getBoundingBox().inflate(5 + homingEnchantmentLevel * 2), entity -> {
