...
public record Climbable(Identifier id, BlockPredicate blocks, boolean canStickToWalls, boolean canClimbCeilings) {
    public static final Codec<Climbable> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Identifier.CODEC.fieldOf("key").forGetter(Climbable::id),
