...
public record FluidVision(Identifier id, HolderSet<FluidType> fluidTypes, LevelBasedValue percentage) {
    public static final Codec<FluidVision> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Identifier.CODEC.fieldOf("id").forGetter(FluidVision::id),
    ...
    public record Mapped(Identifier id, HolderSet<FluidType> fluidTypes, float percentage) {
